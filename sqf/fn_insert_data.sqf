...
if !(_result) then {
	diag_log format["Insert function: %1 failed, message: %2",_function,_count];
};
//this should return the count or the auto increment field last id - do with it what you will
[_result,_count]
